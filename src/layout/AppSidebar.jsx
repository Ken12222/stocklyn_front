...
import { CardSim, ContainerIcon, DollarSignIcon, IdCard, ListIcon, PiggyBank, WarehouseIcon } from "lucide-react";
  ...
  const navItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Add Products", path: "/add_product", pro: false },
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "New Invoice", path: "/add_invoice", pro: false },
      ]
    },
    auth?.role === "admin" && {
      icon: <IdCard />,
